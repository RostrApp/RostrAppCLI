...
#         shift = schedule_shift(schedule.id, datetime(2025,11,17,8), datetime(2025,11,17,12), self.alice.id, self.admin.id)
...
#         assert "Alice" in day_data["completed"]
...
#         shift = schedule_shift(schedule.id, start, end, self.bob.id, self.admin.id)
#         shift.updateStatus()
#         db.session.commit()
...
#         shift = schedule_shift(schedule.id, datetime(2025,11,17,8), datetime(2025,11,17,12), self.steve.id, self.admin.id)
...
#         summary = get_summary(schedule.id)
#         day_data = summary["days"]["2025-11-17"]
#         assert "Steve" in day_data["missed"]
